define({
    ...
    page: {
        ...
        cases: {
            this: "Inštancie",
            my: "Moje Inštancie",
            all: "Všetky Inštancie",
            noCasesAvailableForThisView: "Pre toto zobrazenie neexistujú žiadne Inštancie",
            noTasksForThisCaseAvailable: "V tejto inštancii už pre Vás nie sú žiadne úlohy"
        },
        mycases: {
            this: "Moje Inštancie",
            my: "Moje Inštancie",
